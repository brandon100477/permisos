...
<html lang="en">
    ...
    <body>
        ...
        <form id="formulario" method="POST" action="{{ route('ruta_actualizar') }}" enctype="multipart/form-data">
            ...
            <label name="titulo" id="titulo" class="textos"><h5> Tipo de permiso:</h5></label><br>
            ...
            <h5 name="nombreApellido" id="nombreApellido"class="textos" >Pendiente de firmar por Talento Humano.</h5><br><br><br>
