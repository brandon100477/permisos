...
<body>
        ...
        <form method="POST" action="{{ route('ruta_firmar') }}" enctype="multipart/form-data">
        @csrf
        ...
        <label for="opcion2">Otro: <input type="text" class="" id="justificado" name="justificado" placeholder="Justificar: Día de cumpleaños" ></label><br>
                ...
                <div class="boton">
                    <a href="{{ route('ruta_prevista') }}">Pre-vista</a>

                    <button class="btn-lg boton primary" type="submit" name="button1" id="button1">Firmar</button>
                </div>
